...
<!-- 
已经将此文件中的css删除。
如果引用了此文件表示页面还没有按css js加载方案优化，请优化页面。
 -->
...
<script language="Javascript" src="${ctx}/common/js/HashMap.js" ></script>
<script language="Javascript" src="${ctx}/common/js/accessKey.js" ></script>
