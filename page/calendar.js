...
//var WriteHead=1;
document.write('<iframe style="position:absolute;width:150px;display:none;" name="divCalendar" id="divCalendar" frameborder="0" scrolling="no"></iframe>')
/*头部信息CSS及JS函数*/
...
'body,html{margin:0px;height:100%;background:#FFF;}a,li,input {font-family:"Verdana","Arial";font-size:11px;}'+
...
'ul li{float:left;margin-left:1px;padding-top:1px;display:inline;text-align:center;width:20px;height:20px;}'+
'#Tools {width:148px;background:#5563B0;padding:0px;}'+
'#Tools li{padding-bottom:1px;}'+
'#Tools a{color:#FFF;}'+
'#Tools a:hover{border:1px solid #2E3665;background:#979FCE;}'+
'#Title {width:148px;background:#CAD3E8;border-bottom:1px solid #000;}'+
'#Title li{height:16px;padding-top:2px;}'+
'#sYear,#sMonth {width:40px;height:16px;border:1px solid #88A9C9;border-right:0;padding-top:2px;}'+
'#SArr {width:17px;height:18px;background:#E2EBF4;font-size:10px;text-align:center;color:#5563B0;border:1px solid #88A9C9;border-left:0;margin-right:2px;cursor:pointer;}'+
'#Select {width:57px;border:1px solid #8AC;background:#FFF;height:146px;}'+
...
'<div id="SelectYear" style="left:2px;" onclick="ShowSelect(\'SelectYear\',\'Y\');"><div id="Select"><a href="javascript:;" onmousedown="mdown=window.setInterval(\'Scroll(\\\'Up\\\',\\\'Y\\\')\',50);" onmouseup="window.clearInterval(mdown);" onmouseout="window.clearInterval(mdown);" id="SelectBn" style="border-bottom:1px solid #5563B0;"><font face="Webdings">&#53;</font></a><div id="SelectYearItem">'+
...
'<div id="SelectMonth" style="left:63px;" onclick="ShowSelect(\'SelectMonth\',\'M\');"><div id="Select"><a href="javascript:;" onmousedown="mdown=window.setInterval(\'Scroll(\\\'Up\\\',\\\'M\\\')\',50);" onmouseup="window.clearInterval(mdown);" onmouseout="window.clearInterval(mdown);" id="SelectBn" style="border-bottom:1px solid #5563B0;"><font face="Webdings">&#53;</font></a><div id="SelectMonthItem">'+
...
'ipt><div style="border:1px solid #6A84C8;height:'+(64+21*Trn)+'px;"><ul>'+
'<li style="width:124px;background:#FFF;padding-bottom:1px;" id="SelectArea"><div id="sYear" onclick="ShowSelect(\'SelectYear\',\'Y\');">'+year+'年</div><div id="SArr" onclick="ShowSelect(\'SelectYear\',\'Y\');"><font face="Webdings">&#54;</font></div>'+
...
else{content+='<li style="width:60px;"><a href="javascript:parent.Calendar_GetDate('+date.getFullYear()+','+(date.getMonth()+1)+','+date.getDate()+');">选择本日</a></li>';}
...
if(start>0){content+='<li style="width:'+(start*21-1)+'px;"></li>';}
for(i=1;i<=DayNum;i++)
{
content+='<li><a href="#"'
