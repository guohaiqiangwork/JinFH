...
if(!kde&&!saf){
	...
	if(menuALIGN=="free"||remoteTRI0802RING||(!showBORDERS&&!stretchMENU)){bWidth-=sbaa;}
...
function openSubMenu(mid) {
	...
	if(!remoteTRI0802RING) { snObj.style.visibility="visible"; }
...
function loadFunction() {
	...
	if(remoteTRI0802RING) { document.addEventListener("mousemove", menuListen, false); }
