...
var baseHREF = "/reins/common/js/menu/";	// base path to .js files for the script (ie: resources/)

var zORDER = 	1000;		// base z-order of nav structure (not ns4)



var mCOLOR = 	"EEEEEB";	// main nav cell color

var rCOLOR = 	"B6B6B5";	// main nav cell rollover color

var bSIZE = 	0;		// main nav border size

var bCOLOR = 	"white"	// main nav border color

var aLINK = 	"747474";	// main nav link color
...
var smCOLOR = 	"EEEEEB";	// submenu cell color



var srCOLOR = 	"B6B6B5";	// submenu cell rollover color

var sbSIZE = 	0;		// submenu border size

var sbCOLOR = 	"cccccc"	// submenu border color

var saLINK = 	"747474";	// submenu link color
...
var shOPACITY = 35;		// submenu drop shadow opacity (not ie4,ns4 or opera)
